...
<body class="notranslate">
  ...
  <section id="work">
    ...
    <div class="card">
      ...
      <div class="card-content">
        <span class="card-title activator"
          >Github Finder<i class="material-icons right">more_vert</i></span
        >
        <p><a href="#"></a></p>
      </div>
      <div class="card-reveal">
        ...
        <p>
          ...
          Github qui retourne les noms des développeurs contenant la chaine de
          caractère entrée. Lorsque l'on clique sur le nom du développeur,
          quelques informations supplémentaires apparaissent telles que les
          noms des derniers repositories, ses followers, sa biographie, et un
          lien vers son profil complet.
        </p>
        <div class="card-button">
          <a
            class="waves-effect waves-light btn"
